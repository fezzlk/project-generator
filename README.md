...
詳細は [docs/setup-guide.md](docs/setup-guide.md) を参照。個人プロジェクトを GitHub / pico / Linear へ登録する手順は [docs/pico-linear-registration.md](docs/pico-linear-registration.md)、Codex / Claude Code 共通設定の導入は [docs/agent-kit.md](docs/agent-kit.md) を参照。
